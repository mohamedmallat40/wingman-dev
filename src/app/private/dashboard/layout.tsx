...
export default function DashboardLayout({ children }: Readonly<TRootLayout>) {
  return (
    <Container>
      <HeaderPage
        title='Dashboard'
        description='Connect with top experts to solve your digital challenges or share your expertise with others.'
      />
      <Container>
        <QuickActions />
        <TabsRouting />
        <SectionContainer className='my-4 py-8'>{children}</SectionContainer>
      </Container>
    </Container>
  );
}
