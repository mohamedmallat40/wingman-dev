...
export default function LiveActivityBar({ onNotificationClick, className = '' }: LiveActivityBarProps) {
  ...
  return (
    ...
    >
      <div className="bg-background/80 backdrop-blur-md border border-default-200 rounded-full shadow-lg px-4 py-2 max-w-md mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-foreground-600">LIVE</span>
          </div>
