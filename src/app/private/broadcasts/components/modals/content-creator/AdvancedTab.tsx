        ...
        <Controller
          ...
          render={({ field }) => (
            ...
            >
              <SelectItem
                key='public'
                startContent={<Icon icon='solar:global-linear' className='h-4 w-4' />}
              >
              ...
              <SelectItem
                key='private'
                startContent={<Icon icon='solar:lock-linear' className='h-4 w-4' />}
              >
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className='flex items-center justify-between'>
                ...
                <Switch isSelected={field.value} onValueChange={field.onChange} color='warning' />
              </div>
            )}
          />
        </div>
