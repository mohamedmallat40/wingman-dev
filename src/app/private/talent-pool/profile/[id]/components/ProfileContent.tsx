...
import { getUserInitials, mapUserType, stripHtml, truncateText } from '../../../utils/talent-utils';
import {
  type Education,
  type Experience,
  type Language,
...
const ProfileContent: React.FC<ProfileContentProps> = ({
  ...
  // Removed complex animation variants for cleaner approach
              ...
              {user.aboutMe ? (
                ...
                <div className='flex items-center justify-center py-12 text-center'>
                  <div>
                    ...
                    />
                    <p className='text-foreground-500'>{t('talentPool.cards.noAboutAvailable')}</p>
                  </div>
                </div>
              )}
            </CardBody>
                ...
                <div className='flex items-center justify-center py-12 text-center'>
                  <div>
                    <Icon
                      ...
                      className='text-default-300 mx-auto mb-4 h-12 w-12'
                    />
                    <p className='text-foreground-500'>{t('talentPool.profile.noExperience')}</p>
                  </div>
                </div>
              )}
            </CardBody>
                ...
                <div className='flex items-center justify-center py-12 text-center'>
                  <div>
                    <Icon
                      ...
                      className='text-default-300 mx-auto mb-4 h-12 w-12'
                    />
                    <p className='text-foreground-500'>{t('talentPool.profile.noEducation')}</p>
                  </div>
                </div>
              )}
            </CardBody>
                ...
                <div className='flex items-center justify-center py-12 text-center'>
                  <div>
                    <Icon
                      ...
                      className='text-default-300 mx-auto mb-4 h-12 w-12'
                    />
                    <p className='text-foreground-500'>{t('talentPool.cards.noSkillsListed')}</p>
                  </div>
                </div>
              )}
            </CardBody>
                ...
                <div className='flex items-center justify-center py-12 text-center'>
                  <div>
                    <Icon
                      ...
                      className='text-default-300 mx-auto mb-4 h-12 w-12'
                    />
                    <p className='text-foreground-500'>{t('talentPool.profile.noLanguages')}</p>
                  </div>
                </div>
              )}
            </CardBody>
