...
export const getSkillIcon = (skillName: string): string => {
  ...
  if (
    ...
    normalizedSkill.includes('vue') ||
    normalizedSkill.includes('angular')
  ) {
  ...
  if (
    ...
    normalizedSkill.includes('java') ||
    normalizedSkill.includes('php')
  ) {
  ...
  if (
    normalizedSkill.includes('marketing') ||
    normalizedSkill.includes('seo') ||
    normalizedSkill.includes('ads')
  ) {
  ...
  if (
    ...
    normalizedSkill.includes('analysis')
  ) {
    return skillIcons.data!;
  }

  if (
    normalizedSkill.includes('mobile') ||
    normalizedSkill.includes('ios') ||
    normalizedSkill.includes('android')
  ) {
    return skillIcons.mobile!;
  }

  if (
    normalizedSkill.includes('project') ||
    normalizedSkill.includes('management') ||
    normalizedSkill.includes('agile')
  ) {
