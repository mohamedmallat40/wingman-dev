  ...
  >
    <div className="mb-6">
      ...
      <p className="text-default-500 max-w-md mx-auto">
        We couldn't find any agencies matching your criteria. Try adjusting your filters or search query.
      </p>
    </div>
    <Button
      color="primary"
...
const AgencyList: React.FC<AgencyListProps> = ({
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        console.log('Agency sentinel intersecting:', entry.isIntersecting, 'hasNextPage:', hasNextPage, 'isLoadingMore:', isLoadingMore);
  ...
  return (
    <div className="space-y-6">
      ...
      {hasNextPage && (
        <div id="agency-sentinel" className="h-20 flex items-center justify-center mt-8">
          {isLoadingMore ? (
