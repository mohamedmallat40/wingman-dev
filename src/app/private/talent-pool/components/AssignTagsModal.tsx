...
const AssignTagsModal: React.FC<AssignTagsModalProps> = ({ 
  ...
  const tagColors = [
    '#3B82F6', '#10B981', '#8B5CF6', '#059669', '#F59E0B', 
    '#DC2626', '#6366F1', '#84CC16', '#0EA5E9', '#EC4899'
  ];
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <Input
                ...
                startContent={<Icon icon="solar:hashtag-linear" className="h-4 w-4 text-default-400" />}
              />
              <Button
                size="sm"
                color="primary"
                ...
                startContent={!isCreatingTag ? <Icon icon="solar:add-circle-bold" className="h-4 w-4" /> : null}
              >
                {t('common.create')}
              </Button>
            </div>
          ...
          <div className="space-y-3">
            ...
            {availableTags.length === 0 && (
              <div className="text-center p-4 text-default-500">
                <Icon icon="solar:tag-linear" className="h-12 w-12 mx-auto mb-2 text-default-300" />
                <p className="text-small">
                  {t('talentPool.modals.assignTags.noTags')}
                </p>
              </div>
            )}
          </div>
