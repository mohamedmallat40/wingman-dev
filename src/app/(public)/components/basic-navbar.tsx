    ...
    >
      ...
      >
        ...
        <div className='hidden flex-col sm:flex'>
          <p className='leading-tight font-bold tracking-[0.4em] text-inherit'> WINGMAN</p>
      ...
      <NavbarMenu
        className='bg-default-200/50 shadow-medium dark:bg-default-100/50 top-[calc(var(--navbar-height)_-_1px)] max-h-fit pt-6 pb-6 backdrop-blur-md backdrop-saturate-150'
        motionProps={{
